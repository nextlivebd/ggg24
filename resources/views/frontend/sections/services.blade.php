    ...
    <section id="services" class="services section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>We run all kinds of Graphic Design, Branding & 3D services with 19+ years of experience</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row align-items-center">
          <div class="col-lg-4 mb-5 mb-lg-0">
            <h2 class="fw-bold mb-4 servies-title">Knock Us if you need to create an awesome visual identity!</h2>
            <p class="mb-4">Global Graphic Giant offers custom creative design solutions using cutting-edge tools.</p>
