    ...
    <section id="testimonials" class="testimonials section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>What our global clients say about our stunning graphic solutions, outstanding creative design, and 24/7 support.</p>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    <h2>Outstanding Quality & Professionalism</h2>
                    <p>
                      I am working with Global Graphic Giant for the past 5 years. I find Global Graphic Giant is very professional and always putting the needs of their customers first.
                    </p>
                    <p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    <h2>Best Design Partner</h2>
                    <p>
                      I have worked with many different design agencies, and Global Graphic Giant is without doubt, one of the best companies.
                    </p>
                    <p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    <h2>
                      Highly Creative Visual Solutions
                    </h2>
                    <p>
                      We partnered with GGG to build our entire brand identity from scratch. Their team delivered a stunning, highly creative solution that has accelerated our market growth.
                    </p>
                    <p>
